    ...
    <div class="card-controls sm:flex">
        <div class="w-full sm:w-1/2">
            ...
            @if(file_exists(app_path('Http/Livewire/ExcelExport.php')))
                <livewire:excel-export model="Family" format="csv" />
                <livewire:excel-export model="Family" format="xlsx" />
                <livewire:excel-export model="Family" format="pdf" />
            @endif
                ...
                <thead>
                    <tr>
                        ...
                        <th>
                            ...
                            @include('components.table.sort', ['field' => 'parent.name'])
                        </th>
                        <th>
                        </th>
                    </tr>
